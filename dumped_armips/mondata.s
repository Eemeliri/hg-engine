...
// all the mon personal data.  all learnset data is in data/learnsets, including tm's
...
mondata SPECIES_CHARMELEON, "Charmeleon"
    ...
    items ITEM_CHARIZARDITE_X, ITEM_CHARIZARDITE_Y
    genderratio 31
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_SQUIRTLE, "Squirtle"
    ...
    abilities ABILITY_TORRENT, ABILITY_FILTER
    runchance 0
...
mondata SPECIES_WARTORTLE, "Wartortle"
    ...
    items ITEM_NONE, ITEM_BLASTOISINITE
    genderratio 31
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_METAPOD, "Metapod"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_BUG, EGG_GROUP_BUG
    abilities ABILITY_SHED_SKIN, ABILITY_TINTED_LENS
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_WEEDLE, "Weedle"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_BUG, EGG_GROUP_BUG
    abilities ABILITY_SHIELD_DUST, ABILITY_MERCILESS
    runchance 0
...
mondata SPECIES_BEEDRILL, "Beedrill"
    basestats 65, 95, 40, 90, 45, 80
    types TYPE_BUG, TYPE_POISON
    catchrate 45
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 1
    items ITEM_POISON_BARB, ITEM_BEEDRILLITE
    genderratio 127
    eggcycles 15
    basefriendship 70
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_PIDGEOTTO, "Pidgeotto"
    basestats 63, 60, 55, 71, 60, 50
    types TYPE_NORMAL, TYPE_FLYING
    catchrate 120
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 2, 0, 0
    items ITEM_NONE, ITEM_PIDGEOTITE
    genderratio 127
    eggcycles 15
    basefriendship 70
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_PIDGEOT, "Pidgeot"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_FLYING, EGG_GROUP_FLYING
    abilities ABILITY_KEEN_EYE, ABILITY_NO_GUARD
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
...
mondata SPECIES_SPEAROW, "Spearow"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FLYING, EGG_GROUP_FLYING
    abilities ABILITY_KEEN_EYE, ABILITY_ADAPTABILITY
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
...
mondata SPECIES_ZUBAT, "Zubat"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FLYING, EGG_GROUP_FLYING
    abilities ABILITY_INNER_FOCUS, ABILITY_MERCILESS
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
...
mondata SPECIES_ODDISH, "Oddish"
    ...
    abilities ABILITY_CHLOROPHYLL, ABILITY_FLOWER_VEIL
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
...
mondata SPECIES_KADABRA, "Kadabra"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 0, 2, 0
    items ITEM_TWISTED_SPOON, ITEM_ALAKAZITE
    genderratio 63
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_BELLSPROUT, "Bellsprout"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_GRASS, EGG_GROUP_GRASS
    abilities ABILITY_CHLOROPHYLL, ABILITY_LIMBER
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_GOLEM, "Golem"
    basestats 100, 120, 130, 45, 55, 65
    types TYPE_ROCK, TYPE_GROUND
    catchrate 45
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 3, 0, 0, 0
...
mondata SPECIES_PONYTA, "Ponyta"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_ADAPTABILITY, ABILITY_FLASH_FIRE
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
...
mondata SPECIES_SLOWBRO, "Slowbro"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 2, 0, 0, 0
    items ITEM_KINGS_ROCK, ITEM_SLOWBRONITE
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_GASTLY, "Gastly"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS
    abilities ABILITY_LEVITATE, ABILITY_PICKPOCKET
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
...
mondata SPECIES_HAUNTER, "Haunter"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 0, 2, 0
    items ITEM_SPELL_TAG, ITEM_GENGARITE
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_GENGAR, "Gengar"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS
    abilities ABILITY_CURSED_BODY, ABILITY_PICKPOCKET
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
...
mondata SPECIES_KANGASKHAN, "Kangaskhan"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 2, 0, 0, 0, 0, 0
    items ITEM_NONE, ITEM_KANGASKHANITE
    genderratio 254
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_GOLDEEN, "Goldeen"
    ...
    abilities ABILITY_SWIFT_SWIM, ABILITY_TECHNICIAN
    runchance 0
    colorflip BODY_COLOR_RED, 0
...
mondata SPECIES_SCYTHER, "Scyther"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 1, 0, 0, 0, 0
    items ITEM_NONE, ITEM_SCIZORITE
    genderratio 127
    eggcycles 25
    basefriendship 50
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_GYARADOS, "Gyarados"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 0
    items ITEM_NONE, ITEM_GYARADOSITE
    genderratio 127
    eggcycles 5
    basefriendship 50
    growthrate GROWTH_SLOW
...
mondata SPECIES_JOLTEON, "Jolteon"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_VOLT_ABSORB, ABILITY_ELECTRIC_SURGE
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
...
mondata SPECIES_BELLOSSOM, "Bellossom"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_GRASS, EGG_GROUP_GRASS
    abilities ABILITY_CHLOROPHYLL, ABILITY_FAIRY_AURA
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_UMBREON, "Umbreon"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_SYNCHRONIZE, ABILITY_DEFIANT
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
...
mondata SPECIES_MISDREAVUS, "Misdreavus"
    ...
    growthrate GROWTH_FAST
    egggroups EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS
    abilities ABILITY_LEVITATE, ABILITY_UNAWARE
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
...
mondata SPECIES_STEELIX, "Steelix"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 2, 0, 0, 0
    items ITEM_METAL_COAT, ITEM_STEELIXITE
    genderratio 127
    eggcycles 25
    basefriendship 50
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_HERACROSS, "Heracross"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 0
    items ITEM_NONE, ITEM_HERACRONITE
    genderratio 127
    eggcycles 25
    basefriendship 50
    growthrate GROWTH_SLOW
...
mondata SPECIES_HOUNDOOM, "Houndoom"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 0, 2, 0
    items ITEM_NONE, ITEM_HOUNDOOMINITE
    genderratio 127
    eggcycles 20
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_PHANPY, "Phanpy"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_PICKUP, ABILITY_SAND_FORCE
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
...
mondata SPECIES_ENTEI, "Entei"
    ...
    growthrate GROWTH_SLOW
    egggroups EGG_GROUP_UNDISCOVERED, EGG_GROUP_UNDISCOVERED
    abilities ABILITY_PRESSURE, ABILITY_SOLAR_POWER
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
...
mondata SPECIES_SUICUNE, "Suicune"
    ...
    growthrate GROWTH_SLOW
    egggroups EGG_GROUP_UNDISCOVERED, EGG_GROUP_UNDISCOVERED
    abilities ABILITY_PRESSURE, ABILITY_WATER_BUBBLE
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
...
mondata SPECIES_LARVITAR, "Larvitar"
    ...
    growthrate GROWTH_SLOW
    egggroups EGG_GROUP_MONSTER, EGG_GROUP_MONSTER
    abilities ABILITY_GUTS, ABILITY_ROCK_HEAD
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_PUPITAR, "Pupitar"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 0
    items ITEM_NONE, ITEM_TYRANITARITE
    genderratio 127
    eggcycles 40
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_TYRANITAR, "Tyranitar"
    ...
    growthrate GROWTH_SLOW
    egggroups EGG_GROUP_MONSTER, EGG_GROUP_MONSTER
    abilities ABILITY_SAND_STREAM, ABILITY_ROCK_HEAD
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_TREECKO, "Treecko"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_MONSTER, EGG_GROUP_DRAGON
    abilities ABILITY_OVERGROW, ABILITY_SUPER_LUCK
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_TORCHIC, "Torchic"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_BLAZE, ABILITY_EARLY_BIRD
    runchance 0
    colorflip BODY_COLOR_RED, 0
...
mondata SPECIES_COMBUSKEN, "Combusken"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 1, 0, 0, 1, 0
    items ITEM_NONE, ITEM_BLAZIKENITE
    genderratio 31
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_SWAMPERT, "Swampert"
    ...
    growthrate GROWTH_MEDIUM_SLOW
    egggroups EGG_GROUP_MONSTER, EGG_GROUP_WATER_1
    abilities ABILITY_TORRENT, ABILITY_DRY_SKIN
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
...
mondata SPECIES_SILCOON, "Silcoon"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_BUG, EGG_GROUP_BUG
    abilities ABILITY_SHED_SKIN, ABILITY_COMPOUND_EYES
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
...
mondata SPECIES_KIRLIA, "Kirlia"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 0, 2, 0
    items ITEM_GALLADITE, ITEM_GARDEVOIRITE
    genderratio 127
    eggcycles 20
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_SABLEYE, "Sableye"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 1, 1, 0, 0, 0
    items ITEM_WIDE_LENS, ITEM_SABLENITE
    genderratio 127
    eggcycles 25
    basefriendship 35
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_MAWILE, "Mawile"
    basestats 55, 85, 95, 50, 55, 85
    types TYPE_STEEL, TYPE_FAIRY
    catchrate 45
    baseexp 0 // defined in baseexp.s
    evyields 0, 1, 1, 0, 0, 0
    items ITEM_IRON_BALL, ITEM_MAWILITE
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_FAST
...
mondata SPECIES_AGGRON, "Aggron"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 3, 0, 0, 0
    items ITEM_HARD_STONE, ITEM_AGGRONITE
    genderratio 127
    eggcycles 35
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_MEDICHAM, "Medicham"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 2, 0, 0
    items ITEM_NONE, ITEM_MEDICHAMITE
    genderratio 127
    eggcycles 20
    basefriendship 70
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_MANECTRIC, "Manectric"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 2, 0, 0
    items ITEM_NONE, ITEM_MANECTITE
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_SLOW
...
mondata SPECIES_SWALOT, "Swalot"
    basestats 100, 73, 100, 55, 73, 100
    types TYPE_POISON, TYPE_POISON
    catchrate 75
    baseexp 0 // defined in baseexp.s
    evyields 2, 0, 0, 0, 0, 0
...
mondata SPECIES_SHARPEDO, "Sharpedo"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 0
    items ITEM_DEEP_SEA_TOOTH, ITEM_SHARPEDONITE
    genderratio 127
    eggcycles 20
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_CAMERUPT, "Camerupt"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 1, 0, 0, 1, 0
    items ITEM_RAWST_BERRY, ITEM_CAMERUPTITE
    genderratio 127
    eggcycles 20
    basefriendship 70
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_ALTARIA, "Altaria"
    basestats 75, 90, 90, 80, 70, 105
    types TYPE_DRAGON, TYPE_FLYING
    catchrate 45
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 0, 0, 0, 2
    items ITEM_NONE, ITEM_ALTARIANITE
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_ERRATIC
...
mondata SPECIES_SEVIPER, "Seviper"
    ...
    growthrate GROWTH_FLUCTUATING
    egggroups EGG_GROUP_FIELD, EGG_GROUP_DRAGON
    abilities ABILITY_SHED_SKIN, ABILITY_STRONG_JAW
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
...
mondata SPECIES_SOLROCK, "Solrock"
    ...
    growthrate GROWTH_FAST
    egggroups EGG_GROUP_MINERAL, EGG_GROUP_MINERAL
    abilities ABILITY_LEVITATE, ABILITY_DRY_SKIN
    runchance 0
    colorflip BODY_COLOR_RED, 0
...
mondata SPECIES_LILEEP, "Lileep"
    ...
    growthrate GROWTH_ERRATIC
    egggroups EGG_GROUP_WATER_3, EGG_GROUP_WATER_3
    abilities ABILITY_SUCTION_CUPS, ABILITY_STICKY_HOLD
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
...
mondata SPECIES_BANETTE, "Banette"
    basestats 64, 115, 65, 75, 83, 63
    types TYPE_GHOST, TYPE_NORMAL
    catchrate 45
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 0
    items ITEM_SPELL_TAG, ITEM_BANETTITE
    genderratio 127
    eggcycles 25
    basefriendship 35
    growthrate GROWTH_FAST
...
mondata SPECIES_ABSOL, "Absol"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 2, 0, 0, 0, 0
    items ITEM_LIFE_ORB, ITEM_ABSOLITE
    genderratio 127
    eggcycles 25
    basefriendship 35
    growthrate GROWTH_MEDIUM_SLOW
...
mondata SPECIES_GLALIE, "Glalie"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 2, 0, 0, 0, 0, 0
    items ITEM_NEVER_MELT_ICE, ITEM_GLALITITE
    genderratio 127
    eggcycles 20
    basefriendship 50
    growthrate GROWTH_MEDIUM_FAST
...
mondata SPECIES_HUNTAIL, "Huntail"
    ...
    growthrate GROWTH_ERRATIC
    egggroups EGG_GROUP_WATER_1, EGG_GROUP_WATER_1
    abilities ABILITY_SWIFT_SWIM, ABILITY_ANALYTIC
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
...
mondata SPECIES_BAGON, "Bagon"
    ...
    abilities ABILITY_ROCK_HEAD, ABILITY_INTIMIDATE
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
...
mondata SPECIES_SHELGON, "Shelgon"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 2, 0, 0, 0
    items ITEM_DRAGON_FANG, ITEM_SALAMENCITE
    genderratio 127
    eggcycles 40
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_METANG, "Metang"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 2, 0, 0, 0
    items ITEM_METAL_COAT, ITEM_METAGROSSITE
    genderratio 255
    eggcycles 40
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_METAGROSS, "Metagross"
    ...
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 3, 0, 0, 0
    items ITEM_METAGROSSITE, ITEM_METAL_COAT
    genderratio 255
    eggcycles 40
    basefriendship 35
    growthrate GROWTH_SLOW
...
mondata SPECIES_LATIAS, "Latias"
    basestats 80, 80, 90, 110, 120, 130
...
mondata SPECIES_DEOXYS, "Deoxys"
    ...
    growthrate GROWTH_SLOW
    egggroups EGG_GROUP_UNDISCOVERED, EGG_GROUP_UNDISCOVERED
    abilities ABILITY_PRESSURE, ABILITY_MOODY
    runchance 0
    colorflip BODY_COLOR_RED, 0
...
mondata SPECIES_ELECTIVIRE, "Electivire"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE
    abilities ABILITY_MOTOR_DRIVE, ABILITY_TERAVOLT
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
...
mondata SPECIES_MAGMORTAR, "Magmortar"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE
    abilities ABILITY_FLAME_BODY, ABILITY_TURBOBLAZE
    runchance 0
    colorflip BODY_COLOR_RED, 0
...
mondata SPECIES_LEAFEON, "Leafeon"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_LEAF_GUARD, ABILITY_MOXIE
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
...
mondata SPECIES_DUSKNOIR, "Dusknoir"
    basestats 45, 105, 135, 45, 65, 135
    types TYPE_GHOST, TYPE_GHOST
    catchrate 45
    baseexp 0 // defined in baseexp.s
    evyields 0, 0, 1, 0, 0, 2
...
mondata SPECIES_FROSLASS, "Froslass"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FAIRY, EGG_GROUP_MINERAL
    abilities ABILITY_SNOW_CLOAK, ABILITY_SOUNDPROOF
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
...
mondata SPECIES_OINKOLOGNE, "Oinkologne"
    ...
    growthrate GROWTH_MEDIUM_FAST
    egggroups EGG_GROUP_FIELD, EGG_GROUP_FIELD
    abilities ABILITY_GLUTTONY, ABILITY_GLUTTONY
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
